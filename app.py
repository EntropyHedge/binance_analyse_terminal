...
with first_chart:
    ma_length = st.number_input("Moving Average Länge", min_value=1, max_value=200)
...
with second_chart:
    if type(dataframe) != int:
        ...
        ma_length1 = st.number_input("Volume Moving Average Länge", min_value=1, max_value=200)
